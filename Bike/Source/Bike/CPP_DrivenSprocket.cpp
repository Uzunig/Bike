...
{	
	...
	static ConstructorHelpers::FObjectFinder<UMaterialInterface> DrivenSprocketMaterial(TEXT("/Script/Engine.Material'/Game/Shapes/Steel.Steel'"));
	...
	if (DrivenSprocketVisualAsset.Succeeded() && DrivenSprocketMaterial.Succeeded())
	{
		...
		StaticMesh->SetRelativeRotation(FRotator(0.0, 0.0, 12.0));
