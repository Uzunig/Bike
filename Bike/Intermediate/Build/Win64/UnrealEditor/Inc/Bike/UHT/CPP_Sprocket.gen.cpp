...
// End Cross Module References
	DEFINE_FUNCTION(ACPP_Sprocket::execSetAngularVelocity)
	{
		P_GET_PROPERTY(FDoubleProperty,Z_Param_Value);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->SetAngularVelocity(Z_Param_Value);
		P_NATIVE_END;
	}
	...
	void ACPP_Sprocket::StaticRegisterNativesACPP_Sprocket()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "SetAngularVelocity", &ACPP_Sprocket::execSetAngularVelocity },
	...
	struct Z_Construct_UFunction_ACPP_Sprocket_SetAngularVelocity_Statics
	{
		struct CPP_Sprocket_eventSetAngularVelocity_Parms
		{
			double Value;
		};
	...
	const UECodeGen_Private::FDoublePropertyParams Z_Construct_UFunction_ACPP_Sprocket_SetAngularVelocity_Statics::NewProp_Value = { "Value", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(CPP_Sprocket_eventSetAngularVelocity_Parms, Value), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ACPP_Sprocket_SetAngularVelocity_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ACPP_Sprocket_SetAngularVelocity_Statics::NewProp_Value,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ACPP_Sprocket_SetAngularVelocity_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "CPP_Sprocket.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ACPP_Sprocket_SetAngularVelocity_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ACPP_Sprocket, nullptr, "SetAngularVelocity", nullptr, nullptr, Z_Construct_UFunction_ACPP_Sprocket_SetAngularVelocity_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ACPP_Sprocket_SetAngularVelocity_Statics::PropPointers), sizeof(Z_Construct_UFunction_ACPP_Sprocket_SetAngularVelocity_Statics::CPP_Sprocket_eventSetAngularVelocity_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ACPP_Sprocket_SetAngularVelocity_Statics::Function_MetaDataParams), Z_Construct_UFunction_ACPP_Sprocket_SetAngularVelocity_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ACPP_Sprocket_SetAngularVelocity_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ACPP_Sprocket_SetAngularVelocity_Statics::CPP_Sprocket_eventSetAngularVelocity_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_ACPP_Sprocket_SetAngularVelocity()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ACPP_Sprocket_SetAngularVelocity_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_TeethCount_MetaData[];
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ACPP_Sprocket_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_ACPP_Sprocket_SetAngularVelocity, "SetAngularVelocity" }, // 4259041255
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ACPP_Sprocket_Statics::NewProp_TeethCount_MetaData[] = {
		{ "Category", "CPP_Sprocket" },
		{ "ModuleRelativePath", "CPP_Sprocket.h" },
	};
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_ACPP_Sprocket_Statics::NewProp_TeethCount = { "TeethCount", nullptr, (EPropertyFlags)0x0020080000020001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ACPP_Sprocket, TeethCount), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ACPP_Sprocket_Statics::NewProp_TeethCount_MetaData), Z_Construct_UClass_ACPP_Sprocket_Statics::NewProp_TeethCount_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ACPP_Sprocket_Statics::NewProp_LinkLength_MetaData[] = {
		{ "Category", "CPP_Sprocket" },
		{ "ModuleRelativePath", "CPP_Sprocket.h" },
	};
#endif
	const UECodeGen_Private::FDoublePropertyParams Z_Construct_UClass_ACPP_Sprocket_Statics::NewProp_LinkLength = { "LinkLength", nullptr, (EPropertyFlags)0x0020080000020001, UECodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ACPP_Sprocket, LinkLength), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ACPP_Sprocket_Statics::NewProp_LinkLength_MetaData), Z_Construct_UClass_ACPP_Sprocket_Statics::NewProp_LinkLength_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ACPP_Sprocket_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ACPP_Sprocket_Statics::NewProp_TeethCount,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ACPP_Sprocket_Statics::NewProp_LinkLength,
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projects_Bike_Bike_Source_Bike_CPP_Sprocket_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ACPP_Sprocket, ACPP_Sprocket::StaticClass, TEXT("ACPP_Sprocket"), &Z_Registration_Info_UClass_ACPP_Sprocket, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACPP_Sprocket), 583194613U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projects_Bike_Bike_Source_Bike_CPP_Sprocket_h_2451770345(TEXT("/Script/Bike"),
